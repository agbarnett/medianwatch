...
The title for this blog is a homage the ABC TV show "[Media Watch](https://www.abc.net.au/mediawatch/])" which critiques the Australian media and is never short of content. Similarly there's a lot wrong in the way people use statistics, so this blog is mainly about the use and misuse of statistics.
