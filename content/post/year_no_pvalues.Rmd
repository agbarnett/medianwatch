...
In every case but one the authors removed the p-values, relying instead on confidence intervals. But what was more satisfying is that it spurred some meaningful conversations about p-values and their limitations. My willingness to forgo that most precious of academic credit of a paper meant that my seriousness finally cut through. 
