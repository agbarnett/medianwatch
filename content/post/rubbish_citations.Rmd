...
It's hard to work out why we've been cited, as we didn't even discuss the problem of p-values in this paper. If we did, this sentence would have been an example of the sort of bad statistics that we are trying to avoid.
