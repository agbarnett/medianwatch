...
In my talk on bad statistics in medical research practice, I showed the [infamous plot of z-values](https://agbarnett.github.io/talks/TRI/slides#13) created by [Erik van&nbsp;Zwet](https://onlinelibrary.wiley.com/doi/full/10.1111/stan.12241).

A version of the plot made with David Borg is shown below. The sample size is over 1.1&nbsp;million Z-values.

![](../../public/img/Z_plot.png)
...
I had an interesting question from Kyle Sheldrick about my interpretation, and whether this was predominantly misconduct or mostly publication bias. Publication bias is where journal editors and peer reviewers have a strong bias to accept results that are statistically significant, so this would also create spikes in Z-values at ± 1.96. There's good evidence that publication bias exists, thanks to a [neat randomised trial](https://jamanetwork.com/journals/jamainternalmedicine/fullarticle/226270) that manipulated p-values and found huge differences in acceptance rates.
...
![](../../public/img/Z_plot_plos_one.png)
