...
layout: post
subtitle: Admissions of theft
title: Why blog why now?
---

The title for this blog is stolen from the ABC show "[Media Watch](https://www.abc.net.au/mediawatch/])" which critiques the Australian media and is never short of content. Similarly there's a lot wrong in the world of statistics, so this blog is mainly about the use and misuse of statistics.
