...
library(ggplot2)
# scrabble scores
scrabble = data.frame(L = LETTERS, score = c(1,3,3,2,1,4,3,2,1,8,5,1,3,1,1,3,10,1,1,1,1,4,4,8,4,10))
circular = ggplot(data=scrabble, aes(x=L, y=score))+
  geom_bar(stat = "identity", fill = "dark green", col=NA, width = .9)+
  coord_polar()+
  theme_bw()+
